    ...
    <div>
      <div className="relative">
        ...
        <img
          src={pic1}
          alt=""
          className="w-96 h-full object-cover overflow-hidden"
        />
      ...
      <div className="relative w-full pt-20">
        ...
        <img className="max-w-2/3 h-auto" src={fire} alt="reviews" />
      </div>

      <div className=" text-center lap:text-left bg-blue-50">
